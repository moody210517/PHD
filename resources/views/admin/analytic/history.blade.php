                            ...
                            <div class="col-lg-3 col-6" >
                                <div class="modal-body">
                                    <div class="wrapper-div">                                    
                                        <button class="btn btn-primary" onClick="complete()" id="complete" >Complete</button>
                                        <button class="btn btn-primary" onClick="allocate()" id="allocate" >Allocate</button>
...
<script type="text/javascript">
    ...
    function complete(){
        ...
        $.ajax({
          ...
          url: "{{ URL::to('api/completeAllocation')}}",
          success: function(result) {     
                var res = result.results;
                if(res == 200){
                    //alert("ok");                                        
