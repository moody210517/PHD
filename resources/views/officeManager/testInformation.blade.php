						...
						<div class="card">
			        		...
			        		<div class="d-flex i-con-h-a">
			        			...
			        			<span class="mx-2 mt-1">
							 	...
							 	<div class="row no-gutters pb-1" style="margin-top:10px;">
										<div class="col-9">
											<span class="text-muted"> Blood Pressures Disabled </span>	
										</div>
										<div class="col-3">											
											<span id="oxygen" class="text-muted">{{ $data['oxygen'] }}</span>												
										</div>
								</div>

								<div class="row no-gutters pb-1">
										<div class="col-9">
											<span class="text-muted">SPO2 Disabled</span>	
										</div>
										<div class="col-3">											
											<span id="blood_pressure" class="text-muted">{{ $data['blood_pressure'] }}</span>												
										</div>
								</div>

								<div class="row no-gutters pb-1">
										<div class="col-9">
											<span class="text-muted">GSR Disabled</span>	
										</div>
										<div class="col-3">											
											<span id="gsr" class="text-muted">{{ $data['gsr'] }}</span>												
										</div>
								</div>

								<div class="row no-gutters pb-1">
										<div class="col-9">
											<span class="text-muted"> Phase 1 Failed </span>	
										</div>
										<div class="col-3">											
											<span id="phase1" class="text-muted">{{ $data['phase1'] }}</span>												
										</div>
								</div>

								<div class="row no-gutters pb-1">
										<div class="col-9">
											<span class="text-muted"> Phase 2 Failed </span>	
										</div>
										<div class="col-3">											
											<span id="phase2" class="text-muted">{{ $data['phase2'] }}</span>												
										</div>
								</div>

								<div class="row no-gutters pb-1">
										<div class="col-9">
											<span class="text-muted"> Phase 3 Failed </span>	
										</div>
										<div class="col-3">											
											<span id="phase3" class="text-muted">{{ $data['phase3'] }}</span>												
										</div>
								</div>
								<div class="row no-gutters pb-1">
										<div class="col-9">
											<span class="text-muted"> Phase 4 Failed </span>	
										</div>
										<div class="col-3">											
											<span id="phase4" class="text-muted">{{ $data['phase4'] }}</span>												
										</div>
								</div>

								<div class="row no-gutters pb-1">
										<div class="col-9">
											<span class="text-muted"> Tests Aborted </span>	
										</div>
										<div class="col-3">											
											<span id="test_aborts" class="text-muted">{{ $data['test_aborts'] }}</span>												
										</div>
								</div>
