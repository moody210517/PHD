    ...
    <div id="content" class="flex ">
        <div class="page-container-1" id="page-container">
            <div class="page-title padding pb-0 ">
                <h2 class="text-md mb-0">Add Billing
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="home2" role="tabpanel" aria-labelledby="home-tab">
                <form method="post" action="{{ url('admin/addBill') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <input type="text" name="billing_address1" class="form-control" placeholder="Bill Address 1"  required="required">
                    </div>
                    <div class="form-group">
                        <input type="text" name="billing_address2" class="form-control" placeholder="Bill Address 2"  required="required">
                    </div>
                                    
              
                    <div class="form-group">
                        <input type="text" name="billing_zip" class="form-control" placeholder="Bill Zip"  required="required">
                    </div>
