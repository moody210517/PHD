          ...
          <div class="row no-gutters">
            <div class="col-md-6 bg-gray r-l" style="background:#eee">
              <div class="p-4 d-flex flex-column h-100">
                ...
                <div class="text-right text-inherit"><a href="{{ url('home')}}" class="text-fade"></a></div>
              </div>
            </div>
            ...
            <div class="col-md-6" id="content-body">
              <div class="p-4">
                ...
                <form class=""  action="{{ url('login') }}" method="POST" enctype="multipart/form-data">
