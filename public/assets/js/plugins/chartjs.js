    ...
    $('#chart-line-5').chartjs(
      {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'This week',
                    data: [-3520, -2980, 3200, 5000, 3200, 4800, 4000, 3520, 2980, 3200, 5000, 3200, 4800, 4000],
                    fill: true,
                ...
                {
                    label: 'Last week',
                    data: [3800, 3280, 4500, 3000, 4200, 3000, 3500, 3520, 2980, 3200, 34, 45, 345, 345],
                    fill: false,
                    borderDash: [5,5],
                    pointRadius: 2,
                    tension: 0.35,
        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                  ...
                  tension: 0,
                  borderColor: theme.color.angleLines,
                  borderWidth: 1.5
              }
            ]
        },
