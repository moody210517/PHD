...
@section('content')     
    <div class="page-container-1" id="page-container">
        <div class="page-title padding pb-0 ">
            <h2 class="text-md mb-0" style="padding-bottom: 25px;">Visit Treatment            
            <!-- <a href="{{ url('admin/addUserType') }}" class="btn btn-primary" style="float: right;color: white;">Add Visit Symptoms</a> -->
            </h2>
        </div>
                            ...
                            <tr>
                                ...
                                <!-- <td>
                                    <div style="float:right;">
                                        <a href="{{ url('admin/editUserType', $item->id)}}" class="btn btn-primary">Edit</a>                                    
                                        <button onclick="deleteUser({{$item->id}})" class="btn btn-primary" data-toggle="modal" data-target="#m">Delete</button>
                                    </div>                               
                                </td> -->
                            </tr>
