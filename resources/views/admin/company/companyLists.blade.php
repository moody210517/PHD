...
@section('content')     
    <div class="page-container-1" id="page-container">
        <div class="page-title padding pb-0 ">
            <h2 class="text-md mb-0" style="padding-bottom: 25px;">Company
            
            <a href="{{ url('admin/addCompany') }}" class="btn btn-primary" style="float: right;color: white;">Add Company</a>
            </h2>
        </div>
                    ...
                    <tbody>
                        @foreach ($companies as $user)
                            <tr>
                                ...
                                <td>
                                    {{$user->physical_address1}}
                                </td>                                
                                <td>
                                    <div style="float:right;">
                                        <a href="{{ url('admin/editCompany', $user->auto_num)}}" class="btn btn-primary">Edit</a>                                    
